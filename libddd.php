...
<?php TableOfContents(__FILE__, 3); ?>
      ...
      <h2><a name="sec:what"></a>What is libDDD ?</h2>
        ...
        <p>libDDD is distributed under the terms of <a href="http://www.gnu.org/licenses/lgpl.html">LGPL</a>.</p>
        <p>&nbsp;</p>
	...
	[<a href="http://www.lip6.fr/ddd-download/ICTAC2006.pdf">slides.pdf</a> ]
	...
	The ATPN2002 [<a href="http://www.lip6.fr/ddd-download/PN2002.zip">Presentation slides (ppt)</a> ] are a good starting material to get familiar with homomorphisms, without hierarchy. <br/>
	For some presentation slides more focused on SDD, the [<a href="http://www.lip6.fr/ddd-download/PN2008.zip">ATPN08 slides</a> ] 
	give a good overview. <br/>
        <p> A version of the <a href="./libddd.html/index.html">Technical User Documentation is provided online here</a>, though it could be a bit out of date (last generated June 2010). <br/>
        </p>
		<p>The best way to get started is to browse the examples of the [<a href="https://projets-systeme.lip6.fr/trac/research/libddd/browser/libddd/trunk/demo">demo folder</a> ].  <br /> 
        ...
        <p>The distribution also includes a documentation folder doc/ in which a detailed developer documentation can be generated (requires <a href="www.doxygen.org">doxygen</a>). 
	...
	<p>
		The <a href="manual.php">Documents</a> page holds many related papers which give a formal definition to all the concepts of the library.
		</p>  
...
<p>
	...
	you. <br /> <a href="files/libddd.sh">Download as a shell script</a>
</p>
...
<h4> Code base </h4>
<ul>
<li> We borrowed <a href="http://googlecode.com/sparsehash">google's sparse hash table</a> implementation in C++, which gives low memory footprints with limited time overhead. 
