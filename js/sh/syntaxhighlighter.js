 ...
 * 
 * @version
 * 4.0.1 (Mon, 10 Jul 2017 16:20:07 GMT)
 * 
 * @copyright
...
/***/ (function(module, exports) {
	...
	SyntaxHighlighter.brushes.Custom = function () {
	    ...
	    var keywords = 'GAL transition list array int TRANSIENT label true false typedef self if else fixpoint';
	    //var operators   = 'True False';
	
	    this.regexList = [{ regex: SyntaxHighlighter.regexLib.singleLineCComments, css: 'comments' }, // simple comment
