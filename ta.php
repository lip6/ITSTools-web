...
<p>
	...
	the reference Timed Automata tool <a href="http://www.uppaal.org">Uppaal</a>
	and providing a decent editing front-end. The plugin offers an Xtext based editor 
	(content-assist, correct as you type...) to edit .xta files which is <a href="http://www.it.uu.se/research/group/darts/uppaal/help.php?file=FileFormats.shtml">the textual syntax of Uppaal v4</a>.
</p>
...
The syntax is explained in summarized in the BNF <a href="http://people.cs.aau.dk/~adavid/utap/syntax.html">here</a>
and explained in much more detailed form in <a href=http://www.it.uu.se/research/group/darts/uppaal/help.php?file=System_Descriptions/Model.shtml">the reference manual</a>.
</p>
...
is described here : <a href="./files/xta-bench.pdf">Experiments with XTA (pdf)</a>.
<ol>
...
<p> We have run some benchmark experiments to measure how its-reach scales with respect to Uppaal
 ...
 values, but its-reach supports much higher number of concurrent processes provided maximum clock values
  ...
  <p> The results of these experiments are reported here : <a href="./files/xta-bench.pdf">Experiments with XTA (pdf)</a>. 
...
<p> The models are taken from <a href="www.it.uu.se/research/group/darts/uppaal/benchmarks/">Uppaal benchmark suite</a> : 
<ol>
<li> FDDI token ring protocol : (folder hddi) we have three parameters, i number of process, j a multiplier, k a constant.
We use definitions : <a href="https://srcdev.lip6.fr/trac/research/thierry/browser/PSTL/GAL/fr.lip6.move.xta.benchmarks/hddi/tokenring.gen.awk">SA=k, TRTT=(K+i*j)</a>.
...
<li>An eclipse <a href="itstools.php#sec:modinst">ITS Modeler front-end</a> deployed, since we currently lack command-line version of the transformation tool.</li>
</ul>
</p>
...
<li>a compiled distribution of Memtime (we used <a href="http://tiger.cs.tsinghua.edu.cn/Students/yangjl/memtime/">this version.</a></li>
<li>the <a href="http://move.lip6.fr/software/DDD/itstools.php#sec:cldl">command-line distribution of its-tools</a> (only its-reach really used) </li> 
</ul>
