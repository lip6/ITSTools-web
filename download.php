...
<ul>
<li> <a href="libddd.php#sec:libddd">for libddd </a>
</li><li><a href="itstools.php#sec:modinst">for ITS Modeler eclipse front-end</a>
</li><li><a href="itstools.php#sec:cldl">for ITS tools command-line</a>
</li><li><a href="itstools.php#sec:libitsdl">for source distributions of libits and related tools</a>
</li>
</ul>
...
<ol>
  ...
  <li> Install all the dependecies of GAL, select "Help->install new software" and install ITS modeler as explained for plain users here : <a href="itstools.php#sec:modinst">for ITS Modeler eclipse front-end</a>.
   Reboot.</li>
